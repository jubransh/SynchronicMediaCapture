...
namespace SynchronicMediaCapture
{
    public class Sensor
    {
        ...
        private List<MediaCapture> _initedMediaInstances;
        ...
        public Sensor(MediaCapture mC, Types.Sensor type, MediaFrameSourceGroup sG, MediaFrameSourceGroup privateSG)
        {
            ...
            _initedMediaInstances = new List<MediaCapture>();
        }
        //=======================================================================================================================================================
        //================================================================= Public methods ======================================================================
        public void Init()
        ...
        public void Dispose()
        {
            foreach (var mc in _initedMediaInstances)
            {
                mc.Dispose();
            }
        }
        ...
        private CameraProperties GetCameraProperty(Types.Sensor sensor)
        {
            ...
            _initedMediaInstances.Add(tempMC);
